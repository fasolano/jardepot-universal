...
var NotExistComponent = /** @class */ (function () {
    function NotExistComponent(appSettings, router, formBuilder, appService, activatedRoute) {
    ...
    NotExistComponent.prototype.ngOnInit = function () {
    ...
    NotExistComponent.prototype.onSubmitTeLlamamos = function (values) {
        var _this = this;
        if (this.form.valid) {
    ...
    NotExistComponent.ctorParameters = function () { return [
...
var NotExistModule = /** @class */ (function () {
    function NotExistModule() {
    }
...
//# sourceMappingURL=pages-not-exist-not-exist-module-es5.js.map