...
module.exports = "<div fxLayout=\"row wrap\" fxHide.gt-sm style=\"margin-top: 170px;\">\n    <div fxFlex=\"100\">\n        <mat-card fxLayout=\"row\">\n            <a href=\"https://wa.me/525551857805?text=Hola,%20me%20gustaría%20saber%20\" target=\"_blank\" mat-raised-button class=\" whats\" fxFlex=\"50\" style=\"max-height: 40px;\">\n                <fa-icon [icon]=\"faWhatsapp\" style=\"font-size: 20px;\"></fa-icon> Escríbenos\n            </a>\n            <a href=\"tel:8002129225\" mat-raised-button class=\" llamanos\" fxFlex=\"50\" style=\"max-height: 40px;\">\n                 <mat-icon>phone</mat-icon> Llámanos\n            </a>\n        </mat-card>\n    </div>\n</div>\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(appSettings, router, appService) {
...
var Product = /** @class */ (function () {
    function Product(id, name, images, oldPrice, newPrice, discount, description, availibilityCount, inventory, stock, brand, mpn, productType, dataSheet, metaDescription, metaTitle, idSeccion, cartCount, keywords) {
        this.id = id;
        this.name = name;
        this.images = images;
...
/* harmony import */ var _ngx_lite_json_ld__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @ngx-lite/json-ld */ "./node_modules/@ngx-lite/json-ld/fesm5/ngx-lite-json-ld.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        ...
        component: _pages_pages_component__WEBPACK_IMPORTED_MODULE_1__["PagesComponent"], children: [
            ...
            {
                path: 'cart',
                loadChildren: function () { return __webpack_require__.e(/*! import() | pages-cart-cart-module */ "pages-cart-cart-module").then(__webpack_require__.bind(null, /*! ./pages/cart/cart.module */ "./src/app/pages/cart/cart.module.ts")).then(function (m) { return m.CartModule; }); },
                data: { breadcrumb: 'Carrito de compra' }
            },
            {
                path: 'checkout',
                loadChildren: function () { return __webpack_require__.e(/*! import() | pages-checkout-checkout-module */ "pages-checkout-checkout-module").then(__webpack_require__.bind(null, /*! ./pages/checkout/checkout.module */ "./src/app/pages/checkout/checkout.module.ts")).then(function (m) { return m.CheckoutModule; }); },
                data: { breadcrumb: 'Pago de pedido' }
            },
            {
                path: 'confirmation',
                loadChildren: function () { return __webpack_require__.e(/*! import() | pages-confirmation-confirmation-module */ "pages-confirmation-confirmation-module").then(__webpack_require__.bind(null, /*! ./pages/confirmation/confirmation.module */ "./src/app/pages/confirmation/confirmation.module.ts")).then(function (m) { return m.ConfirmationModule; }); },
                data: { breadcrumb: 'Agradecimiento' }
            },
            {
                path: '',
                loadChildren: function () { return __webpack_require__.e(/*! import() | pages-products-products-module */ "pages-products-products-module").then(__webpack_require__.bind(null, /*! ./pages/products/products.module */ "./src/app/pages/products/products.module.ts")).then(function (m) { return m.ProductsModule; }); },
                data: { breadcrumb: 'Todos los productos' }
            },
            {
                path: '404',
                loadChildren: function () { return __webpack_require__.e(/*! import() | pages-not-exist-not-exist-module */ "pages-not-exist-not-exist-module").then(__webpack_require__.bind(null, /*! ./pages/not-exist/not-exist.module */ "./src/app/pages/not-exist/not-exist.module.ts")).then(function (m) { return m.NotExistModule; }); },
...
var AppService = /** @class */ (function () {
    ...
    AppService.prototype.getProductsRelated = function (product) {
        ...
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('product', product);
        return this.http.get(this.urlAPI + '/api/products/related', { headers: headers, params: params });
    };
    AppService.prototype.getProducts = function (nivel1, nivel2, brandFilter, characteristicFilter) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('nivel1', nivel1).set('nivel2', this.filterHilo(nivel2)).set('brands', brandFilter).set('characteristics', characteristicFilter);
        return this.http.get(this.urlAPI + '/api/products', { headers: headers, params: params });
    };
    AppService.prototype.getSectionsProducts = function (nivel1, nivel2) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('nivel1', nivel1).set('nivel2', this.filterHilo(nivel2));
        return this.http.get(this.urlAPI + '/api/products/sections', { headers: headers, params: params });
    };
    AppService.prototype.getProductByName = function (product) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('product', product);
        return this.http.get(this.urlAPI + '/api/product', { headers: headers, params: params });
    };
    ...
    AppService.prototype.getMenu = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = '';
        return this.http.get(this.urlAPI + '/api/menu/navbar', { headers: headers });
    };
    AppService.prototype.getProductTypes = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = '';
        return this.http.get(this.urlAPI + '/api/menu/productsTypes', { headers: headers });
    };
    AppService.prototype.getBrands = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = '';
        return this.http.get(this.urlAPI + '/api/menu/brands', { headers: headers });
    };
    AppService.prototype.getAdditional = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = '';
        return this.http.get(this.urlAPI + '/api/menu/additional', { headers: headers });
    };
    AppService.prototype.getFilters = function (productType) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('productType', this.filterHilo(productType));
        return this.http.get(this.urlAPI + '/api/products/filters', { headers: headers, params: params });
    };
    ...
    AppService.prototype.addToCart = function (product) {
        ...
        if (this.cookieService.check('session')) {
            var message = void 0, status_1;
            var session = this.cookieService.get('session');
            this.Data.totalPrice = null;
            this.Data.totalCartCount = null;
            var index = this.Data.cartList.findIndex(function (item) { return item.id == product.id; });
            if (index >= 0) {
            ...
            status_1 = 'success';
            this.snackBar.open(message, '×', { panelClass: [status_1], verticalPosition: 'top', duration: 3000 });
            var params = { 'product': JSON.stringify(product), 'quantity': product.cartCount, 'sessionCookie': session };
            return this.http.post(this.urlAPI + '/api/cart/addProduct', params);
        }
        else {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
            this.http.get(this.urlAPI + '/api/session', { headers: headers }).subscribe(function (data) {
                _this.cookieValue = data;
                _this.setCookie('session', JSON.stringify(data), 3, '/');
                _this.addToCart(product);
            });
        }
    };
    AppService.prototype.removeFromCart = function (product) {
        var message, status;
        var session = this.cookieService.get('session');
        message = 'El producto ' + product.name + ' ha sido eliminado del carrito.';
        status = 'error';
        this.snackBar.open(message, '×', { panelClass: [status], verticalPosition: 'top', duration: 3000 });
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('product', product.name).set('sessionCookie', session);
        this.http.delete(this.urlAPI + '/api/cart/removeProduct', { params: params }).subscribe(function (res) {
        });
    };
    AppService.prototype.getProductsCart = function () {
        var session = this.cookieService.get('session');
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('sessionCookie', session);
        return this.http.get(this.urlAPI + '/api/cart/products', { headers: headers, params: params });
    };
    AppService.prototype.resetProductCartCount = function (product) {
        this.removeFromCart(product);
        product.cartCount = 0;
    };
    AppService.prototype.getDistributions = function () {
        return [
    ...
    AppService.prototype.getPaymentMethods = function () {
        return [
    ...
    AppService.prototype.getProductLevels = function ($productType) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('productType', this.filterHilo($productType));
        return this.http.get(this.urlAPI + '/api/product/levels', { headers: headers, params: params });
    };
    AppService.prototype.errorHandl = function (error) {
        var errorMessage = '';
    ...
    AppService.prototype.getProductsSearch = function (valorSearch) {
        var session = this.cookieService.get('session');
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('valorSearch', valorSearch);
        return this.http.get(this.urlAPI + '/api/products/search', { params: params });
    };
    AppService.prototype.getProductsOffer = function () {
        return this.http.get(this.urlAPI + '/api/products/offer');
    };
    AppService.prototype.createOrder = function (forms) {
        var session = this.cookieService.get('session');
        var params = { 'forms': JSON.stringify(forms), 'sessionCookie': session };
        return this.http.post(this.urlAPI + '/api/checkout/createOrder', params);
    };
    AppService.prototype.createMercadopago = function (order, products, client, delivery) {
        var params = { 'order': JSON.stringify(order), 'products': JSON.stringify(products), 'client': JSON.stringify(client), 'delivery': JSON.stringify(delivery) };
        return this.http.post('https://fasolano.com/jardepotAPI/api/checkout/mercadopago', params);
    };
    AppService.prototype.confirmMercadopago = function ($data) {
        var params = { 'data': $data };
        return this.http.post('https://fasolano.com/jardepotAPI/api/confirm/mercadopago', params);
    };
    AppService.prototype.enviarBusqueda = function (forms, busqueda) {
        //  let headers = new HttpHeaders({'Content-Type':'application/x-www-form-urlencoded'});
        var session = this.cookieService.get('session');
        var params = { 'forms': JSON.stringify(forms), 'textoBuscado': busqueda, 'sessionCookie': session };
        return this.http.post(this.urlAPI + '/api/products/sendSearch', params);
    };
    AppService.prototype.sendConfirmationPayment = function ($state, $payment, $data, $token) {
        var session = "";
        if (this.cookieService.check('session')) {
            session = this.cookieService.get('session');
        }
        var params = { 'state': $state, 'payment': $payment, 'data': $data, 'token': $token, 'sessionCookie': session };
        return this.http.post(this.urlAPI + '/api/confirm/checkout', params);
    };
    AppService.prototype.getDescriptionNivel2 = function (nivel1, nivel2) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('nivel1', nivel1).set('nivel2', this.filterHilo(nivel2));
        return this.http.get(this.urlAPI + '/api/products/getDescriptionNivel2', { params: params });
    };
    AppService.prototype.filterHilo = function (productType) {
        var productType1;
    ...
    AppService.prototype.defineBreadcrumb = function ($params, $previousUrl, $component) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('params', $params).set('previousUrl', $previousUrl).set('component', $component);
        return this.http.get(this.urlAPI + '/api/menu/breadcrumb', { params: params });
    };
    AppService.prototype.payPalPayment = function ($id) {
        var products = [];
        this.Data.cartList.forEach(function (obj) {
            var price = obj.newPrice * obj.cartCount;
            var product = {
    ...
    AppService.prototype.getCookie = function (name) {
        var documento = (typeof document !== "undefined") ? document : null;
        if (documento) {
    ...
    AppService.prototype.deleteCookie = function (name) {
...
var Settings = /** @class */ (function () {
    function Settings(name, theme, rtl) {
        this.name = name;
        this.theme = theme;
        this.rtl = rtl;
    }
...
module.exports = "@charset \"UTF-8\";\n.main {\n  min-height: 360px;\n  min-height: calc(100vh - 268px);\n}\n.sidenav {\n  width: 250px;\n  padding: 8px 16px;\n  position: fixed;\n}\n.sidenav .divider {\n  margin: 8px 0;\n}\n.cart-items-count {\n  position: absolute;\n  top: -3px;\n  left: 26px;\n  background: #f44336;\n  height: 18px;\n  width: 18px;\n  line-height: 18px;\n  border-radius: 50%;\n  font-size: 11px;\n}\n.busqueda {\n  min-height: 32px !important;\n}\n.barra {\n  border-radius: 0px 0px 10px 10px;\n  background-color: #f68600;\n  height: 60px;\n}\n.barra a {\n  color: #ffffff;\n}\n.tel-movil {\n  padding: 0 !important;\n  height: 60px !important;\n}\n@media (max-width: 959px) {\n  .barra {\n    border-radius: 0px 0px 10px 10px;\n    background-color: #f68600;\n    height: 32px;\n  }\n\n  .tel-movil {\n    padding: 0 !important;\n    height: 32px !important;\n  }\n}\n.bg-color-jd {\n  background-color: #f68600 !important;\n  color: white !important;\n}\n.fn-color-jd {\n  color: #f68600 !important;\n}\n.title-muted {\n  color: #616161 !important;\n  display: block;\n  text-decoration: none;\n  font-weight: 500;\n  font-size: 18px;\n}\n.bg-color-oferta {\n  background-color: #de1f21 !important;\n  color: #fff !important;\n}\n.tel-title {\n  font-size: 20px;\n}\n.phone-item p {\n  font-size: 19px;\n}\n.phone-item span {\n  font-size: 16px;\n  display: block;\n}\n.bold {\n  font-weight: bold;\n}\n.link-obscure {\n  color: #424242 !important;\n  font-weight: 500;\n}\n#cdk-overlay-0 .mat-menu-panel {\n  min-width: 300px !important;\n  max-width: 900px !important;\n}\n.mat-menu-content div {\n  width: 100%;\n}\n#sidenavMenu {\n  max-width: 100%;\n  width: 80%;\n  background-color: rgba(80, 80, 80, 0.9);\n}\n#sidenavMenu .fll-color-jd {\n  fill: #f68600 !important;\n}\n.parpadea {\n  font-size: 20px;\n  animation-name: parpadeo;\n  animation-duration: 2s;\n  animation-timing-function: linear;\n  animation-iteration-count: infinite;\n  -webkit-animation-name: parpadeo;\n  -webkit-animation-duration: 2s;\n  -webkit-animation-timing-function: linear;\n  -webkit-animation-iteration-count: infinite;\n  margin: 5px;\n}\n@-webkit-keyframes parpadeo {\n  0% {\n    color: #fff;\n  }\n  50% {\n    color: #424242;\n  }\n  100% {\n    color: #fff;\n  }\n}\n@keyframes parpadeo {\n  0% {\n    color: #fff;\n  }\n  50% {\n    color: #424242;\n  }\n  100% {\n    color: #fff;\n  }\n}\n.fixed-header {\n  position: fixed;\n  top: 0;\n  z-index: 2;\n}\n/* ----------- dispositivos móviles ----------- */\n/* cambios css para modo vertical y horizontal */\n@media only screen and (min-width: 320px) and (max-width: 736px) {\n  /* inserta aquí tu código */\n}\n@media only screen and (min-device-width: 320px) and (max-device-width: 736px) {\n  /* inserta aquí tu código */\n}\n.call-footer:hover {\n  opacity: 0.9;\n}\n.cart-footer {\n  position: fixed;\n  width: 40px;\n  height: 40px;\n  cursor: pointer;\n  z-index: 999999;\n  right: 20px;\n  bottom: 185px;\n  opacity: 0.7;\n  color: #fff;\n  background-color: #de1f21;\n  border-radius: 4px;\n}\n.loading-back {\n  position: absolute;\n  z-index: 99;\n  width: 100%;\n  height: 100%;\n  text-align: center;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background-color: #fff;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PagesComponent = /** @class */ (function () {
    function PagesComponent(appSettings, appService, activatedRoute, sidenavMenuService, router, dialog, cookieService, fb, snackBar, _compiler) {
        var _this = this;
        this.appSettings = appSettings;
        this.appService = appService;
        ...
        this.window = (typeof window !== "undefined") ? window : null;
        this.router.events.subscribe(function (event) {
            _this.actualUrl = _this.router.url;
            _this.actualUrls = _this.actualUrl.split('/');
            if (_this.actualUrls[1] == 'catalogo') {
                _this.productoLink = _this.actualUrls[3];
                _this.productFormat = _this.productoLink.replace(/-/g, ' ').replace(/_/g, '-');
                _this.whatsappText = 'mas de ' + _this.productFormat;
                _this.visibleCart = true;
            }
            else {
                _this.whatsappText = '';
    ...
    PagesComponent.prototype.createForm = function () {
        this.formSearch = this.fb.group({
            valorSearch: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required],
        });
    };
    PagesComponent.prototype.getBrands = function () {
        var _this = this;
    ...
    PagesComponent.prototype.getProductsCart = function () {
        var _this = this;
        /*total = [];
        grandTotal = 0;
        cartItemCount = [];
        ...
        if (this.appService.getCookie('session') != "") {
            this.appService.getProductsCart().subscribe(function (res) {
                if (res == null) {
                    ...
                    _this.appService.Data.cartList = JSON.parse(res[0]);
                    _this.appService.Data.totalPrice = null;
                    _this.appService.Data.totalCartCount = null;
                    _this.appService.Data.cartList.forEach(function (product) {
                        _this.appService.Data.totalPrice = _this.appService.Data.totalPrice + (product.cartCount * product.newPrice);
                        _this.appService.Data.totalCartCount = _this.appService.Data.totalCartCount + product.cartCount;
                    });
                }
            });
        }
    };
    PagesComponent.prototype.getAdditional = function () {
        var _this = this;
        this.appService.getAdditional().subscribe(function (data) {
            _this.additional = data;
        });
    };
    PagesComponent.prototype.getProductTypes = function () {
        var _this = this;
    ...
    PagesComponent.prototype.search = function () {
        var valor = this.formSearch.value.valorSearch;
        if (valor !== '') {
    ...
    PagesComponent.prototype.scrollToTop = function () {
        ...
        if (this.window) {
            ...
            var scrollStep_1 = -this.window.pageYOffset / (scrollDuration / 20);
            var scrollInterval_1 = setInterval(function () {
                if (_this.window.pageYOffset !== 0) {
                    _this.window.scrollBy(0, scrollStep_1);
                }
                else {
    ...
    PagesComponent.prototype.openTelephoneDialog = function () {
        var dialogRef = this.dialog.open(_theme_components_menu_telephone_dialog_telephone_dialog_component__WEBPACK_IMPORTED_MODULE_5__["TelephoneDialogComponent"], {
            panelClass: 'telephone-dialog',
            direction: 'ltr'
        });
    };
    PagesComponent.prototype.getProductByUrl = function () {
        var _this = this;
        this.appService.getProductByName(this.productoLink).subscribe(function (data) {
            _this.addProducToCart(data);
        });
    };
    PagesComponent.prototype.addProducToCart = function (product) {
        var _this = this;
        if (this.busy) {
            ...
            this.appService.addToCart(product).subscribe(function (res) {
                _this.router.navigate(['/cart']);
            });
            setTimeout(function () { _this.busy = true; }, 500);
        }
    };
    PagesComponent.prototype.handleImgError = function (ev) {
        var source = ev.srcElement;
        var imgSrc = "assets/images/productos/generico2.jpg";
        source.src = imgSrc;
    };
    PagesComponent.prototype.fixDisappearIOSBug = function () {
...
var BannersComponent = /** @class */ (function () {
    function BannersComponent(appService) {
        this.appService = appService;
        this.banners = [
            {
                'title': 'Jardinería',
    ...
    BannersComponent.prototype.onWindowResize = function () {
        if (this.window) {
            if (this.window.innerWidth < 960) {
                this.bannerResize[0] = {
                    'background-image': 'url(' + this.banners[0].mobile + ')'
...
var ControlsComponent = /** @class */ (function () {
    ...
    ControlsComponent.prototype.addToCart = function (product) {
        ...
        this.appService.addToCart(product).subscribe(function (data) {
        });
        setTimeout(function () {
            _this.busy = false;
        }, 500);
...
var JsonLdComponent = /** @class */ (function () {
    ...
    JsonLdComponent.ctorParameters = function () { return [
...
var PaypalButtonComponent = /** @class */ (function () {
    function PaypalButtonComponent(appService, formBuilder, dialogRef, router, dialog) {
        this.appService = appService;
        ...
        paypal.Buttons({
            ...
            onApprove: function (data, actions) {
                return actions.order.capture().then(function (details) {
                    ...
                    var name = details.purchase_units[0].shipping.name.full_name;
                    var address = Object.values(details.purchase_units[0].shipping.address).toString();
                    var clientForm = JSON.stringify(form.value);
    ...
    PaypalButtonComponent.prototype.showButtonPaypal = function () {
        this.showButton = this.clientForm.invalid;
    };
    PaypalButtonComponent.prototype.chageTerms = function (event) {
        this.terms = !event.checked;
    };
    PaypalButtonComponent.prototype.removeObject = function () {
        this._ref.destroy();
    };
    PaypalButtonComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    PaypalButtonComponent.prototype.openDeliveryTermsDialog = function () {
        ...
        var dialogRef = this.dialog.open(_shared_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_6__["DialogComponent"], {
    ...
    PaypalButtonComponent.ctorParameters = function () { return [
        { type: _app_service__WEBPACK_IMPORTED_MODULE_1__["AppService"] },
...
var ProductDialogComponent = /** @class */ (function () {
    ...
    ProductDialogComponent.prototype.changeString = function ($productType, $brand, $mpn) {
        $brand = $brand.replace(/ /g, "_");
        $mpn = $mpn.replace(/-/g, "_");
        $productType = $productType.replace(/ /g, "_");
        return $productType + '-' + $brand + '-' + $mpn;
    };
    ProductDialogComponent.prototype.changeStringBrand = function ($brand) {
        return $brand.replace(/ /g, "_");
    };
    ProductDialogComponent.prototype.handleImgError = function (ev) {
        var source = ev.srcElement;
        var imgSrc = "assets/images/images/generico2.jpg";
        source.src = imgSrc;
    };
...
var ProductsCarouselComponent = /** @class */ (function () {
    function ProductsCarouselComponent(appSettings, appService, dialog, router, activatedRoute, cd2) {
        this.appSettings = appSettings;
        this.appService = appService;
        this.dialog = dialog;
        this.router = router;
    ...
    ProductsCarouselComponent.prototype.openProductDialog = function (product) {
        var _this = this;
        var dialogRef = this.dialog.open(_product_dialog_product_dialog_component__WEBPACK_IMPORTED_MODULE_4__["ProductDialogComponent"], {
            data: product,
        ...
        dialogRef.afterClosed().subscribe(function (product) {
            if (product) {
                _this.router.navigate(['/', product.id, product.name]);
            }
        });
    };
    ProductsCarouselComponent.prototype.refreshPage = function () {
        var _this = this;
        // @ts-ignore
        ...
        if (this.directiveRef2.swiper()) {
            setTimeout(function () {
                _this.directiveRef2.swiper().lazy.load();
            }, 0);
        }
    };
    ProductsCarouselComponent.prototype.changeString = function ($productType, $brand, $mpn) {
        $brand = $brand.replace(/ /g, "_").toLowerCase();
        $mpn = $mpn.replace(/-/g, "_").toLowerCase();
        $productType = $productType.replace(/ /g, "_").toLowerCase();
        return $productType + '-' + $brand + '-' + $mpn;
    };
    ProductsCarouselComponent.prototype.changeStringBrand = function ($brand) {
        return $brand.replace(/ /g, "_").toLowerCase();
    };
    ProductsCarouselComponent.prototype.handleImgError = function (ev) {
        var source = ev.srcElement;
        var imgSrc = "assets/images/productos/generico2.jpg";
        source.src = imgSrc;
    };
    ProductsCarouselComponent.ctorParameters = function () { return [
...
var SectionsPanelComponent = /** @class */ (function () {
    function SectionsPanelComponent() {
        this.productsType = [];
        this.brands = [];
        this.additional = [];
    }
    SectionsPanelComponent.prototype.ngOnInit = function () {
    };
    SectionsPanelComponent.prototype.changeString = function ($string) {
...
var SectionsSideComponent = /** @class */ (function () {
    function SectionsSideComponent(appService) {
        this.appService = appService;
        this.productTypes = [];
        this.brands = [];
        this.additional = [];
    }
    SectionsSideComponent.prototype.ngOnInit = function () {
        this.getBrands();
        this.getProductTypes();
        this.getAdditional();
    };
    SectionsSideComponent.prototype.getBrands = function () {
        var _this = this;
        this.appService.getBrands().subscribe(function (data) {
            _this.brands = data;
        });
    };
    SectionsSideComponent.prototype.getAdditional = function () {
        var _this = this;
        this.appService.getAdditional().subscribe(function (data) {
            _this.additional = data;
        });
    };
    SectionsSideComponent.prototype.getProductTypes = function () {
        var _this = this;
        this.appService.getProductTypes().subscribe(function (data) {
            _this.productTypes = data;
        });
    };
    SectionsSideComponent.prototype.changeStringBrand = function ($brand) {
        return $brand.replace(/ /g, "-").toLowerCase();
    };
    SectionsSideComponent.ctorParameters = function () { return [
        { type: _app_service__WEBPACK_IMPORTED_MODULE_1__["AppService"] }
    ]; };
...
var TelephoneBarComponent = /** @class */ (function () {
    function TelephoneBarComponent() {
        this.faWhatsapp = _fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_1__["faWhatsapp"];
    }
    TelephoneBarComponent.prototype.ngOnInit = function () {
    };
...
var BreadcrumbComponent = /** @class */ (function () {
    function BreadcrumbComponent(appSettings, router, appService, activatedRoute, title, sidenavMenuService) {
        var _this = this;
        this.appSettings = appSettings;
        this.router = router;
        this.appService = appService;
    ...
    BreadcrumbComponent.prototype.parseRoute = function (node) {
        ...
        if (node.data['breadcrumb']) {
            if (node.routeConfig.path === "") {
                var params = JSON.stringify(node.firstChild.params);
                // @ts-ignore
                this.appService.defineBreadcrumb(params, this.previousUrl, node.firstChild.component.name).subscribe(function (data) {
                    // @ts-ignore
    ...
    BreadcrumbComponent.prototype.setBreadcrumOthersPages = function (node) {
        var urlSegments = [];
...
var FooterComponent = /** @class */ (function () {
    ...
    FooterComponent.prototype.openAvisoPrivacidadDialog = function () {
        var textBody = 'Los datos personales (Los Datos) solicitados, son tratados por Jardepot S.A. de C.V. (Jardepot),' +
        ...
        var dialogRef = this.dialog.open(_shared_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_1__["DialogComponent"], {
            panelClass: 'generic-dialog',
            direction: 'ltr'
        });
    ...
    FooterComponent.prototype.openAvisoLegalDialog = function () {
        var textBody = ' TÉRMINOS Y CONDICIONES DE USO\n' +
            '      <br>\n' +
            '      <br>\n' +
            '      1. Objeto.\n' +
            '      <br>\n' +
...
var MenuComponent = /** @class */ (function () {
    function MenuComponent(appService) {
        this.appService = appService;
        this.faWhatsapp = _fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_1__["faWhatsapp"];
    }
    MenuComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.appService.getMenu().subscribe(function (data) {
            _this.menuTopBar = data;
        });
    };
    MenuComponent.prototype.changeString = function ($strign) {
...
var TelephoneDialogComponent = /** @class */ (function () {
    function TelephoneDialogComponent(dialogRef) {
        this.dialogRef = dialogRef;
        this.config = {};
    }
    TelephoneDialogComponent.prototype.ngOnInit = function () {
    };
    TelephoneDialogComponent.prototype.ngAfterViewInit = function () {
        this.config = {
            slidesPerView: 1,
            spaceBetween: 0,
            keyboard: true,
    ...
    TelephoneDialogComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    TelephoneDialogComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"] }
    ]; };
    ...
    return TelephoneDialogComponent;
}());
...
var SidenavMenuComponent = /** @class */ (function () {
    function SidenavMenuComponent(sidenavMenuService, appService) {
        this.sidenavMenuService = sidenavMenuService;
        this.appService = appService;
    }
    ...
    SidenavMenuComponent.prototype.changeString = function ($string) {
...
var SidenavMenu = /** @class */ (function () {
    ...
    SidenavMenu.ctorParameters = function () { return [
        { type: Number },
        { type: String },
        { type: String },
        { type: String },
...
var SidenavMenuService = /** @class */ (function () {
    ...
    SidenavMenuService.prototype.closeOtherSubMenus = function () {
        if (this.document) {
            var subMenu = document.getElementsByClassName('sub-menu');
            Array.from(subMenu).forEach(function (item) {
                item.classList.remove('show');
            });
            var menu = document.getElementsByClassName('mat-button');
    ...
    SidenavMenuService.ctorParameters = function () { return [
...
var FilterPricePipe = /** @class */ (function () {
    ...
    FilterPricePipe.prototype.transform = function (products, min, max) {
        return products.filter(function (product) { return product.newPrice <= max && product.newPrice >= min; });
    };
...
var OrderByPipe = /** @class */ (function () {
    ...
    OrderByPipe.prototype.transform = function (products, $type, $categories) {
        switch ($type) {
            case 'relevant':
                return products;
                break;
