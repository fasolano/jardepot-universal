...
var AppService = /** @class */ (function () {
    ...
    AppService.prototype.getProductsRelated = function (product) {
        ...
        return this.http.get(this.urlAPI + '/public/api/products/related', { headers: headers, params: params });
    };
    AppService.prototype.getProducts = function (nivel1, nivel2, brandFilter, characteristicFilter) {
        ...
        return this.http.get(this.urlAPI + '/public/api/products', { headers: headers, params: params });
    };
    AppService.prototype.getSectionsProducts = function (nivel1, nivel2) {
        ...
        return this.http.get(this.urlAPI + '/public/api/products/sections', { headers: headers, params: params });
    };
    AppService.prototype.getProductByName = function (product) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('product', product);
        return this.http.get(this.urlAPI + '/public/api/product', { headers: headers, params: params });
    };
    ...
    AppService.prototype.getMenu = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = '';
        return this.http.get(this.urlAPI + '/public/api/menu/navbar', { headers: headers });
    };
    AppService.prototype.getProductTypes = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = '';
        return this.http.get(this.urlAPI + '/public/api/menu/productsTypes', { headers: headers });
    };
    AppService.prototype.getBrands = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = '';
        return this.http.get(this.urlAPI + '/public/api/menu/brands', { headers: headers });
    };
    AppService.prototype.getAdditional = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = '';
        return this.http.get(this.urlAPI + '/public/api/menu/additional', { headers: headers });
    };
    AppService.prototype.getFilters = function (productType) {
        ...
        return this.http.get(this.urlAPI + '/public/api/products/filters', { headers: headers, params: params });
    };
    ...
    AppService.prototype.addToCart = function (product) {
        ...
        if (this.cookieService.check('session')) {
            ...
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
            this.http.get(this.urlAPI + '/public/api/session', { headers: headers }).subscribe(function (data) {
                _this.cookieValue = data;
                _this.cookieService.set('session', JSON.stringify(data), null, '/');
    ...
    AppService.prototype.removeFromCart = function (product) {
        ...
        this.http.delete(this.urlAPI + '/public/api/cart/removeProduct', { params: params }).subscribe(function (res) {
        });
    };
    AppService.prototype.getProductsCart = function () {
        ...
        return this.http.get(this.urlAPI + '/public/api/cart/products', { headers: headers, params: params });
    };
    ...
    AppService.prototype.getProductLevels = function ($productType) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('productType', this.filterHilo($productType));
        return this.http.get(this.urlAPI + '/public/api/product/levels', { headers: headers, params: params });
    };
    ...
    AppService.prototype.getProductsSearch = function (valorSearch) {
        ...
        return this.http.get(this.urlAPI + '/public/api/products/search', { params: params });
    };
    ...
    AppService.prototype.getDescriptionNivel2 = function (nivel1, nivel2) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('nivel1', nivel1).set('nivel2', this.filterHilo(nivel2));
        return this.http.get(this.urlAPI + '/public/api/products/getDescriptionNivel2', { params: params });
    };
    ...
    AppService.prototype.defineBreadcrumb = function ($params, $previousUrl, $component) {
        ...
        return this.http.get(this.urlAPI + '/public/api/menu/breadcrumb', { params: params });
    };
...
var ControlsComponent = /** @class */ (function () {
    ...
    ControlsComponent.prototype.increment = function (count) {
        ...
        if (this.type == 'cart') {
            this.busy = true;
            setTimeout(function () { _this.busy = false; }, 800);
        }
    ...
    ControlsComponent.prototype.addToCart = function (product) {
        ...
        this.appService.addToCart(product);
        setTimeout(function () { _this.busy = false; }, 500);
    };
...
var PaypalButtonComponent = /** @class */ (function () {
    function PaypalButtonComponent(appService, formBuilder, dialogRef, router) {
        this.appService = appService;
