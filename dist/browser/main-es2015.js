...
let AppService = class AppService {
    ...
    getMenu() {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        let params = '';
        return this.http.get(this.urlAPI + '/api/menu/navbar', { headers });
    }
    getProductTypes() {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        let params = '';
        return this.http.get(this.urlAPI + '/api/menu/productsTypes', { headers });
    }
    getBrands() {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        let params = '';
        return this.http.get(this.urlAPI + '/api/menu/brands', { headers });
    }
    getAdditional() {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        let params = '';
        return this.http.get(this.urlAPI + '/api/menu/additional', { headers });
    }
    ...
    addToCart(product) {
        if (this.cookieService.check('session')) {
            ...
            this.http.get(this.urlAPI + '/api/session', { headers }).subscribe(data => {
                ...
                this.setCookie('session', JSON.stringify(data), 3, '/');
